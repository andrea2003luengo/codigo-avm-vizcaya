...
- Modelos base, meta-modelos y codificaciones (`.joblib`): Archivos comprimidos correspondientes a los modelos de Nivel 0 (ElasticNet, Random Forest, LightGBM, XGBoost), los meta-modelos de Nivel 1 (Stacking híbrido) y las codificaciones mediante One-Hot Encoding y Target Encoding.
